...
wget --no-proxy --timeout=10 --tries=2 -qO "$REAL_HOME/.ssh/amisad-demo-key"     "${BASE}/handoff/amisad-demo-key"
wget --no-proxy --timeout=10 --tries=2 -qO "$REAL_HOME/.ssh/amisad-demo-key.pub" "${BASE}/handoff/amisad-demo-key.pub"
