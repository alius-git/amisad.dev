...
**Companion documents:** [personas.md](personas.md) - [applications.md](applications.md) - [scenarios.md](scenarios.md) - diagrams under [design/](design/), indexed in [section 9](#9-diagrams)
...
|---|----------|--------------|-------|
| 1 | [POC overview](design/01-overview.md) | flowchart x2 | The seven top-level POC blocks; the lab deployment topology. |
...
- Foundation services (`fabric-coordinator`, `slice-runtime`, `identity-mock`, `ledger-svc`) appear as external boxes in every application diagram -- they are defined in section 4 above and drawn open in doc 1.
