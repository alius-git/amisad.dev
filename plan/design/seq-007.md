...
See [00-index.md](00-index.md) · [SCENARIO-007](../scenarios.md#scenario-007-enterprise-integration-onboarding-and-inventory-truth-matching). ledger-svc is folded into seller-svc's settlement step; the matching fabric is folded into the coordinator.
