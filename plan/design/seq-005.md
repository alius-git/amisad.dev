# SCENARIO-005 sequence — Campaign-Boosted Match, Edge Creative Serving, and Attribution Credit
...
See [../design.md](../design.md#9-diagrams) · [SCENARIO-005](../scenarios.md#scenario-005-campaign-boosted-match-edge-creative-serving-and-attribution-credit). Maya is folded into the buyer app; Elena's offer arrives via the coordinator's seller-svc fetch.
