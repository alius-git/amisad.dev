...
See [00-index.md](00-index.md) · [SCENARIO-005](../scenarios.md#scenario-005-campaign-boosted-match-edge-creative-serving-and-attribution-credit). Maya is folded into the buyer app; Elena's offer arrives via the coordinator's seller-svc fetch.
